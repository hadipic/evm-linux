...
static napi_value create_dataview(napi_env env, napi_callback_info info) {
  size_t argc = 3;
  napi_value args[3];
...
static napi_value create_data_view_from_js_dataview(napi_env env,
...
static napi_value init(napi_env env, napi_value exports) {
  napi_property_descriptor descriptors[] =
      { DECLARE_NAPI_PROPERTY("CreateDataView", create_dataview),
        DECLARE_NAPI_PROPERTY("CreateDataViewFromJSDataView",
                              create_data_view_from_js_dataview) };
