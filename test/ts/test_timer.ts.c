...
extern ts_value_t *__get_dict(ts_obj_object_t *obj, uint16_t key);
...
extern void __set_dict(ts_obj_object_t *obj, uint16_t key, ts_value_t *v);
...
ts_value_t timeout(ts_runtime_t *e, ts_obj_object_t *this, ts_obj_object_t *func, ts_value_t *local){
    ...
    {
        uint16_t key = ts_strpool_append(e, "hello EVM", 0);
...
ts_value_t __main__(ts_runtime_t *e, ts_obj_object_t *this){
    ...
    __set_dict(scope, "timer", local + 2);
